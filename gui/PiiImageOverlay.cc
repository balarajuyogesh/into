...
/***** PiiImageOverlay *****/
PiiImageOverlay::Data::Data() : bEnabled(true)
{}
...
void PiiImageOverlay::setEnabled(bool enabled) { d->bEnabled = enabled; }
...
bool PiiImageOverlay::enabled() const { return d->bEnabled; }
