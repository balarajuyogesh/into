 ...
 *
 * @note This module is no longer actively developed. It is provided
 * for Qt4 support only. New applications employing Qt5 are encouraged
 * to use the PiiQml module instead.
 *
