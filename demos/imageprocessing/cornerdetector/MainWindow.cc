...
void MainWindow::init()
{
  ...
  _pThresholdSlider->setValue(_pCornerDetector->property("threshold").toInt());
...
PiiEngine* MainWindow::createEngine()
{
  ...
  pConversionSwitch->connectOutput("gray image", _pCornerDetector, "image");
  pConversionSwitch->connectOutput("color image", pAnnotator, "image");
  _pCornerDetector->connectOutput("corners", pAnnotator, "annotation");
