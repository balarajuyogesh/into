...
protected:
  QStringList requiredPlugins() const { return QStringList() << "piiimage" << "piicolors" << "piibase" << "piiflowcontrol"; }
...
private:
  ...
  PiiOperation *_pImageFileReader, *_pColorConverter, *_pSwitch;
};
