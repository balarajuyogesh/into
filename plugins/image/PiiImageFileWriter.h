...
class PII_IMAGE_EXPORT PiiImageFileWriter : public PiiDefaultOperation
{
   ...
   * @p filename input is connected, the extension will be added to
   * file names only if #changeExtension is @p true.
   */
  ...
  /**
   * If this flag is set to @p true, the extension of the file name
